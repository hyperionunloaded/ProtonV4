...
local function makeSplash()
	...
	logo.Position = UDim2.new(0.5, 0, 0, 148)
	logo.Image = "rbxassetid://14368322199"
	...
	sub.Position = UDim2.new(0.5, 0, 0, 228)
	...
	track.Position = UDim2.new(0.5, 0, 0, 262)
